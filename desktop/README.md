...
The 0.1.12 Mac preview is **Developer ID signed and notarised**, with hardened runtime and a stapled Apple ticket. It remains a preview: physical capture/audio acceptance and the first automatic update from 0.1.11 still require a completed installed-app check. Earlier published previews were ad-hoc signed.
