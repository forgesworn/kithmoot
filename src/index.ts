...
export { issueAgentOwnership, verifyAgentOwnership, normaliseAgentOwnership, ownershipEvent, agentOwnershipFromEvent, OWNERSHIP_EVENT_KIND } from './ownership.js'
export type { IssueAgentOwnershipOptions, VerifyAgentOwnershipOptions, OwnershipVerdict, OwnershipFields } from './ownership.js'
