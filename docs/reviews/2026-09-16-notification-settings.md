...
Desktop 0.1.4 packages were built from runtime source at 78228211027cbc1cf49ba3bfe696acb52454a186, pass all five native journeys and packaged macOS smoke, and are installed on M1/M4 with backups. All three versioned downloads match their checksums over HTTPS. Subsequent WebKit viewport-resize correction is a web-client follow-up; the desktop artifacts retain their exact tested source and hashes.
