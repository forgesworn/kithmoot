...
2. **Read and adopt the assessments and drafts**, or send them for legal
   ...
   behind them.
3. **Name the person accountable** for the Online Safety Act's illegal
   ...
   it as `[DECISION]`.
4. **Decide whether KithMoot states a minimum age**, which the terms and
   the children's access assessment both currently leave open rather than
   assume.
5. **Publish the linked pages** (`site/terms/`, `site/privacy/`,
