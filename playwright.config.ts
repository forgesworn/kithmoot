...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ['desktop-room-layout.spec.ts', 'portrait-share.spec.ts', 'call-layout.spec.ts'],
      use: {
        ...devices['Desktop Chrome'],
