...
export default defineConfig({
  ...
  projects: [
    {
      name: 'firefox',
      testMatch: ['chat-reliability.spec.ts', 'nostr-rooms.spec.ts', 'room-switching.spec.ts', 'conversation-search.spec.ts', 'drafts.spec.ts', 'site.spec.ts'],
