...
export default defineConfig({
  ...
  testMatch: ['persistent-groups.spec.ts', 'workspace.spec.ts', 'share-viewer.spec.ts', 'chat-comfort.spec.ts', 'messages.spec.ts', 'model-shortcuts.spec.ts', 'e2e.spec.ts', 'media.spec.ts', 'soak.spec.ts', 'agent.spec.ts', 'effects.spec.ts', 'relay-capability.spec.ts', 'peer-assist.spec.ts', 'rooms.spec.ts', 'speaking.spec.ts', 'verification.spec.ts', 'channels.spec.ts', 'chat-reliability.spec.ts', 'updates.spec.ts', 'nostr-rooms.spec.ts', 'room-switching.spec.ts', 'conversation-search.spec.ts', 'drafts.spec.ts', 'home.spec.ts', 'site.spec.ts'],
  ...
  projects: [
    {
      name: 'firefox',
      testMatch: ['persistent-groups.spec.ts', 'workspace.spec.ts', 'chat-comfort.spec.ts', 'messages.spec.ts', 'model-shortcuts.spec.ts', 'chat-reliability.spec.ts', 'nostr-rooms.spec.ts', 'room-switching.spec.ts', 'conversation-search.spec.ts', 'drafts.spec.ts', 'home.spec.ts', 'site.spec.ts'],
