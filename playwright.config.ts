...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ['desktop-room-layout.spec.ts', 'portrait-share.spec.ts', 'call-layout.spec.ts', 'call-focus.spec.ts'],
      use: {
        ...devices['Desktop Chrome'],
